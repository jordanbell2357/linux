...
```console
ubuntu@LAPTOP-JBell:~$ echo $TERM
xterm-256color
```

```console
ubuntu@LAPTOP-JBell:~$ infocmp xterm-256color
...
```console
ubuntu@LAPTOP-JBell:~$ tput longname
xterm with 256 colors
```

```console
ubuntu@LAPTOP-JBell:~$ tput colors
256
```

```console
ubuntu@LAPTOP-JBell:~$ tput cols
110
```
...
```bash
tput setaf 5; printf "This text has magenta foreround."; tput sgr0; echo
```
